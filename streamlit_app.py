...
header[data-testid="stHeader"]{background:#FFFFFF!important;height:3.75rem!important;z-index:99999!important;pointer-events:auto!important;border-bottom:1px solid #E7EBF1!important}
[data-testid="stToolbar"]{display:flex!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important}
#MainMenu{visibility:visible!important;pointer-events:auto!important}
...
.block-container{max-width:100%!important;padding:0!important;margin:0!important}.topbar{height:82px;background:linear-gradient(90deg,var(--y),#FFC83E 62%,var(--y));display:flex;align-items:center;justify-content:space-between;padding:0 5%;border-bottom:1px solid rgba(0,0,0,.05)}
