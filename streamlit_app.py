...
with st.sidebar:
 ...
 with st.form("cfg"):
  ...
  st.divider(); st.subheader("Cartões e redirecionamentos"); st.caption("PNG padronizado: canvas 128×128, conteúdo até 104×104 e exibição 56×56 px.")
